...
const SuggestedPosts = ({ className, header, posts = [], tags }) => {
  return (
    <div
      className={`w-full shadow-[rgba(7,_65,_210,_0.3)_0px_9px_30px] lg:translate-y-[50px] rounded-lg p-4 ${className}`}
    >
      <h2 className="font-medium font-roboto text-dark-hard mt-8 md:text-xl lg:mt-4">
        {header}
      </h2>
      <div className="grid gap-y-5 mt-5 grid-cols-2 md:gap-x-5 lg:grid-cols-1">
        {posts.map((item) => (
          <div
            key={item._id}
