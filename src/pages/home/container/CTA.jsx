      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <p className="text-dark-light text-sm mt-6 leading-7 py-3 md:text-center md:text-base lg:text-left">
              <span className="text-secondary font-bold italic md:not-italic md:font-normal md:text-dark-light">
